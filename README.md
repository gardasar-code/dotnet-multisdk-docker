...
> 🐳 Dockerfile для разработки на нескольких версиях .NET SDK одновременно: .NET 5 (amd64), 6, 8, 9, 10.0 Подходит для CI/CD, миграций, тестирования и совместимости.

## Features

- В образ включены все необходимые SDK: 5.0 (amd64), 6.0, 8.0, 9.0, 10.0
